...
function toggleVideo() {
    if (!isVideo) {
        updateNote.innerText = "I start video..."
  ...
  try {
    ...
    function startVideo() {
      handTrack.startVideo(video).then(function (status) {
          ...
          if (status) {
              updateNote.innerText = "Video started. I'm looking for hands!"
              isVideo = true
    ...
    startVideo()
    var options = {mimeType: 'video/webm; codecs=vp9', bitsPerSecond: 999000};
